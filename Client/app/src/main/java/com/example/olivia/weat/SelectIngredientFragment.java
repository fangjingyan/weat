...
public class SelectIngredientFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState){
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                new Thread(new SelectIngredientFragment.SendChooseInfo()).start();
            }
        });
    }
    public class SendChooseInfo implements Runnable{
        ...
        public void run(){
            ...
            selectConditions.put("Meat", mealMessage);
            selectConditions.put("Vegetable", vegetableMessage);
            // selectConditions.put("Rating", ratingMessage);
            List<String> restaurants = WebService.executeHttpGetDish(selectConditions);
            // need to change
...
//            restaurants.add("street3");`
            ...
            mListener.onFragmentInteraction1(Uri.parse(restaurants_Info));
        }
    }
    ...
    public void getvegetable(View view){
        ...
        if(vegetablebuttonflag.get(resname) == 0){
            ...
            if(vegetableMessage.length() != 0){
                vegetableMessage = vegetableMessage + "," +resname;}
                else{
                vegetableMessage = resname;
            }
        }
        else{
